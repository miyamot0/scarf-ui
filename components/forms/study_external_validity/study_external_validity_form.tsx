...
export function StudyExternalValidityForm({ study }: { study?: StudyObject }) {
    ...
    const form = useForm<z.infer<typeof StudyExternalValiditySchema>>({
        ...
        defaultValues: {
            Social_Validity_1: study?.ExternalValidity.Questions.find(
                (q) => q.QuestionID === 'Social_Validity_1'
            )?.Response,
            Social_Validity_2: study?.ExternalValidity.Questions.find(
                (q) => q.QuestionID === 'Social_Validity_2'
            )?.Response,
            Social_Validity_3: study?.ExternalValidity.Questions.find(
                (q) => q.QuestionID === 'Social_Validity_3'
            )?.Response,
            Social_Validity_4: study?.ExternalValidity.Questions.find(
                (q) => q.QuestionID === 'Social_Validity_4'
            )?.Response,
            Social_Validity_5: study?.ExternalValidity.Questions.find(
                (q) => q.QuestionID === 'Social_Validity_5'
            )?.Response,
            ...
            Maintenance_1: study?.ExternalValidity.Questions.find(
                (q) => q.QuestionID === 'Maintenance_1'
            )?.Response,
            Maintenance_2: study?.ExternalValidity.Questions.find(
                (q) => q.QuestionID === 'Maintenance_2'
            )?.Response,
            Maintenance_3: study?.ExternalValidity.Questions.find(
    ...
    function onSubmit(values: z.infer<typeof StudyExternalValiditySchema>) {
        ...
        let questions = study.ExternalValidity.Questions.map((q) => {
            return { ...q }
        })
    ...
    function manual_overrides(question: QuestionObjectHolder, value: string) {
        ...
        if (
            question.QuestionID === 'Generality_Boundedness_1' &&
            value === 'No'
        ) {
        ...
        if (
            question.QuestionID === 'Generality_Boundedness_3' &&
            value === 'No'
        ) {
        ...
        if (
            question.QuestionID === 'Generality_Boundedness_5' &&
            value === 'No'
        ) {
