...
const content: TutorialSection[] = [
    {
        heading:
            '3a. Results are visulized in the "Results" tab of the SCARF-UI app',
        subcontent: [
    ...
    {
        heading:
            '3b. Figure 1: Demonstrations of Functional Relations and Study Rigor',
        subcontent: [
    ...
    {
        heading:
            '3c. Figure 2: Maintenance/Durability of Outcomes and Size of Programmed Follow-up Window',
        subcontent: [
    ...
    {
        heading:
            '3d. Figure 3: Generalization/Generality of Outcomes and Rigor/Depth of Generalization Explored',
        subcontent: [
